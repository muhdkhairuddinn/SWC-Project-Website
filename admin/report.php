...
<head>
    ...
    <style>
        ...
        .table {
    width: 100%;
    max-width: 100%; /* Pastikan table tidak lebih dari container */
    border-collapse: collapse;
    table-layout: fixed; /* Pastikan table tak melarikan kolum */
}
...
.table td {
    overflow: hidden; /* Elak kandungan terlalu besar */
...
<body>
    ...
    <div class="container">
        ...
        <div class="revenue-card">
            <h2>Total Revenue: RM<?php echo number_format($total_revenue, 2); ?></h2>
        </div>
    </div>
