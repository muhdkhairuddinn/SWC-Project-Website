    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=faq">FAQ</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about">About</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=my_orders">My Orders</a></li>

                
                <?php if(isset($_SESSION['login_user_id'])): ?>
                <!-- Check if the user is a customer (login_type == 3) -->
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> | <a href="https://mail.google.com/mail/?view=cm&to=kl2311015305@student.utpm.edu.my&su=Complaint%20Regarding%20Pizza&body=Hi%20Team,%0D%0A%0D%0AI%20would%20like%20to%20report%20the%20following%20issue:%0D%0A%0D%0A" target="_blank">muhdkhairuddinn@gmail.com</a></div></div>
        </footer>
